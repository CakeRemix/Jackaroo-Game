...
import view.ControlViewCards;
import view.DiscardToFirePit;
import view.View;
...
public class Game implements GameManager {
    ...
    private int turn;
    public static int discardIndex = -1;
    ...
    public void endPlayerTurn() throws GameException {
    ...
    public void endPlayerTurn2() throws GameException {
        Card selected = players.get(currentPlayerIndex).getSelectedCard();
        
        players.get(currentPlayerIndex).getHand().remove(selected);
        if(selected!=null){
        	firePit.add(selected);
            DiscardToFirePit.discardToFirePit(ControlViewCards.cards.get(selected));
            System.out.println(players.get(currentPlayerIndex).getName()+" Played: "+selected.getImageCode());
    ...
    public void discardCard(Colour colour) throws CannotDiscardException {
        for (int i = 0;i<players.size();i++) {
            ...
            if (player.getColour() == colour) {
                ...
                System.out.println("CARD DISCARDED FROM: "+player.getName());
                discardIndex = i;
    ...
    public int getCurrentPlayerIndex1(){
    	return currentPlayerIndex;
    }
    public int getNextPlayerIndex1(){
    	return (getCurrentPlayerIndex1()+1)%4;
    }
}
