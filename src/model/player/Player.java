...
public class Player {
    ...
    public int getSelectedMarbles2(){
    	int n = 0;
    	for(int i =0;i<selectedMarbles.size();i++){
    		if(selectedMarbles.get(i)!=null)
    			n++;
    	}
    	return n;
    }
    ...
    public void deselectAll2() {
        ...
        for(int i =0;i<View.bottomPlayer.getChildren().size();i++){
        	View.bottomPlayer.getChildren().get(i).setEffect(null);
        	View.bottomPlayer.getChildren().get(i).setScaleX(1);
        	View.bottomPlayer.getChildren().get(i).setScaleY(1);
        }
    }
